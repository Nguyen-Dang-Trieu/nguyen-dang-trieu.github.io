...
### Non-Blocking IO
Điều đó có nghĩa là sau khi gọi một hàm, **caller** không đợi giá trị trả về của hàm và luồng **(thread)** tiếp tục chạy các chương trình khác (thực hiện các thao tác khác hoặc tiếp tục duyệt xem hàm có trả về giá trị hay không). </br>
