...
- Giai đoạn 1: Chờ dữ liệu sẵn sàng -> Hệ điều hành chờ gói dữ liệu từ mạng, sau đó lưu vào bộ đệm trong kernel.
- Giai đoạn 2: Sao chép dữ liệu -> Dữ liệu từ bộ đệm kernel được sao chép sang vùng nhớ của ứng dụng.

Hoạt động của socket stream:
- Bước 1: Chờ gói dữ liệu đến từ mạng và được lưu trữ trong một bộ đệm của kernel.
- Bước 2: Sao chép dữ liệu từ bộ đệm kernel sang bộ đệm của ứng dụng (buff).
